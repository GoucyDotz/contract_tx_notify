...
while True:
	try:
		...
		for contra in setting.param_list:
			...
			txData = pd.read_csv(setting.param[contra]['csv'], encoding='utf8', dtype={'input': str, 'contractAddress': str, 'cumulativeGasUsed': str, 'gasUsed': str, 'confirmations': str, 'methodId': str, 'functionName': str})
			#  set param
